...
*/}}
{{- define "kubeware-server.fullname" -}}
...
Common labels
*/}}
{{- define "kubeware-server.labels" -}}
helm.sh/chart: {{ include "kubeware-server.chart" . }}
{{ include "kubeware-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kubeware-server.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kubeware-server.name" . }}
...
*/}}
{{- define "kubeware-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kubeware-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
