...
*/}}
{{- define "kubeware-service-provider.name" -}}
...
*/}}
{{- define "kubeware-service-provider.fullname" -}}
...
*/}}
{{- define "kubeware-service-provider.chart" -}}
...
Common labels
*/}}
{{- define "kubeware-service-provider.labels" -}}
helm.sh/chart: {{ include "kubeware-service-provider.chart" . }}
{{ include "kubeware-service-provider.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kubeware-service-provider.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kubeware-service-provider.name" . }}
...
*/}}
{{- define "kubeware-service-provider.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kubeware-service-provider.fullname" .) .Values.serviceAccount.name }}
{{- else }}
